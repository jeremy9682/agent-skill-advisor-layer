...
| `arbitration` | `claude-fable-5-1` **max**/careful | This seat **is** the tie-break; not a writer | Claude login | None without user waiver | Using the producer family as the arbitrator |
